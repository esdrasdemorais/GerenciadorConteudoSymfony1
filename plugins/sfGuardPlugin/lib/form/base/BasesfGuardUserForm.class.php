...
class BasesfGuardUserForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_guard_user_permission_list' => new sfWidgetFormPropelSelectMany(array('model' => 'sfGuardPermission')),
      'sf_guard_user_group_list'      => new sfWidgetFormPropelSelectMany(array('model' => 'sfGuardGroup')),
    ));
