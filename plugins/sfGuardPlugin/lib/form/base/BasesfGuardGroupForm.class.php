...
class BasesfGuardGroupForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'sf_guard_group_permission_list' => new sfWidgetFormPropelSelectMany(array('model' => 'sfGuardPermission')),
      'sf_guard_user_group_list'       => new sfWidgetFormPropelSelectMany(array('model' => 'sfGuardUser')),
    ));
